...
<body>
    ...
    ?>
        ...
        <div class="card mb-5" style="width: 100%;">
            <div class="card-body">
                <h2 class="card-title"> USERNAME:  <?php echo $getUserByID['username']?> </h2>
                <h4 class="card-subtitle"> Portfolio Owner: <span class="badge text-bg-secondary"> <?php echo $getUserByID['first_name'] . ' ' . $getUserByID['last_name'] ?> </span></h4>
            </div>
        </div>
        <h3> Add a project </h3>
        <div class="mb-5">
