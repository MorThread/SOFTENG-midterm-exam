			...
			<?php foreach ($getAllUsers as $row) { ?>
				<li class="mb-3">
					<div class="card text-center">
						...
						<div class="card-body">
							<h3 class="card-title"> <b><?php echo $row['username']; ?> </b></h3>
						...
						<div class="card-footer text-body-secondary">
							...
							<a href="editUser.php?user_id=<?php echo $row['user_id']; ?>" class="a-secondary">Edit User</a>
							<a href="deleteUser.php?user_id=<?php echo $row['user_id']; ?>" class="a-secondary">Delete User</a>
						</div>
					</div>
				</li>
